...
```bash
# Basic options
dbx --redis-url redis://localhost:6379 --port 8080
...
- **Getting Started**: Follow the [quick start guide](/getting-started)
- **Configuration**: Learn about [advanced configuration](/configuration)
- **Deployment**: Deploy to production with our [deployment guides](/deployment/docker)
- **API Reference**: Explore the complete [API documentation](/api/rest)
