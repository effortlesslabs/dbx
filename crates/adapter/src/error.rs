...
pub enum ConnectionError {
    #[error("Failed to connect: {0}")] ConnectionFailed(String),

    #[error("Connection timeout: {0}")] Timeout(String),

    #[error("Authentication failed: {0}")] AuthenticationFailed(String),

    #[error("Connection closed: {0}")] ConnectionClosed(String),

    #[error("Invalid connection URL: {0}")] InvalidUrl(String),

    #[error("Connection pool exhausted: {0}")] PoolExhausted(String),
}
...
pub enum OperationError {
    ...
    #[error("Invalid key format: {0}")] InvalidKey(String),

    #[error("Invalid value format: {0}")] InvalidValue(String),

    #[error("Operation timeout: {0}")] Timeout(String),

    #[error("Operation failed: {0}")] Failed(String),
...
pub enum AdapterError {
    #[error("Connection error: {0}")] Connection(#[from] ConnectionError),

    #[error("Operation error: {0}")] Operation(#[from] OperationError),
